      ...
      <div className="contactDiv flex">
       ...
       <div className="footerCard flex">
         ...
         <div className="logoDiv">
          ...
          Unforgettable adventures worldwide. Responsible and immersive travel experiences. Expertly crafted itineraries for authentic encounters. Local guides, insider knowledge, and hidden gems. Join us and embrace new cultures, forge friendships, create memories
          </div>
         ...
         <div className="footerDiv flex">
           ...
           <small>COPYRIGHTS RESERVED - JOÃOBOGO 2022</small>
         </div>
       </div>
